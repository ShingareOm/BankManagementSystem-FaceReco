...
public:
	...
	//friend struct node* initialize_file(struct node* head);
};
...
{
	system("cls");
	cout << "                                  WELCOME TO APPLY SECTION" << endl << endl;
	string test;
	int chk3 = 0, chk = 0;
	string ac_no, pass;
	int esc = 0, chk1 = 0;
...
void allDetails(struct node* head)
{
	...
	string email[100];
	string account[100];
	string branch_name[100];
	string date_date[100];
	string is_co[100];
	string minor[100];
	string date_year[100];
	string gender[100];
	string father_name[100];
	string mother_name[100];
	string name_First_name[100];
	string name_Middel_name[100];
	string name_Last_name[100];
	string add_ress_pin_code[100];
	string add_ress_add_ress[100];
	string mobile[100];
	string add_ress_state[100];
	string DOB_date[100];
	string DOB_month[100];
	string indian[100];
